...
class TestPart3Screen extends StatefulWidget {
  const TestPart3Screen({super.key});

  @override
  State<TestPart3Screen> createState() => _TestPart3ScreenState();
}

class _TestPart3ScreenState extends State<TestPart3Screen> {
  ...
  void submitResponses() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => TestPart4Screen(),
      ),
    );
  }
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          Text(
            LocaleKeys.Lower_Extremity_Function.tr(),
            textAlign: TextAlign.center,
            style: const TextStyle(
              fontSize: 24,
              fontWeight: FontWeight.bold,

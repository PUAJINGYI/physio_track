...
class DailyQuestionListScreen extends StatefulWidget {
  const DailyQuestionListScreen({Key? key}) : super(key: key);

  @override
  State<DailyQuestionListScreen> createState() =>
      _DailyQuestionListScreenState();
}

class _DailyQuestionListScreenState extends State<DailyQuestionListScreen> {
  QuestionService questionService = QuestionService();
  NotificationService notificationService = NotificationService();
  late Future<List<Question>> _dailyQuestionListFuture;
  ...
  void initState() {
    super.initState();
    _dailyQuestionListFuture = _fetchQuestionList();
  }

  Future<List<Question>> _fetchQuestionList() async {
    return await questionService.fetchQuestionsByTopic("daily");
  }
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<Question>>(
      future: _dailyQuestionListFuture,

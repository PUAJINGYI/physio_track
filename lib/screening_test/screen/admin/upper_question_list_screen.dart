...
class UpperQuestionListScreen extends StatefulWidget {
  const UpperQuestionListScreen({Key? key}) : super(key: key);

  @override
  State<UpperQuestionListScreen> createState() =>
      _UpperQuestionListScreenState();
}

class _UpperQuestionListScreenState extends State<UpperQuestionListScreen> {
  QuestionService questionService = QuestionService();
  late Future<List<Question>> _upperQuestionListFuture;
  ...
  Future<List<Question>> _fetchQuestionList() async {
    return await questionService.fetchQuestionsByTopic("upper");
  }
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<Question>>(
      future: _upperQuestionListFuture,

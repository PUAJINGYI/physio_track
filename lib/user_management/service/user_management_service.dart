...
Future<void> deleteUser(int id) async {
  ...
  final questionResponseCollection = FirebaseFirestore.instance.collection('questionResponses');

  // Delete the user document
  await usersCollection.where('id', isEqualTo: id).get().then((querySnapshot) {
    querySnapshot.docs.forEach((doc) async {
      ...
      final userQuizResponsesQuery =
          await questionResponseCollection.where('userId', isEqualTo: doc.id).get();
